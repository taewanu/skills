...
* **[step-back-as-user](skills/engineering/step-back-as-user/SKILL.md)** — Step out of the solution frame and re-enter as the end user. Surfaces friction. Stops before redesigning.
