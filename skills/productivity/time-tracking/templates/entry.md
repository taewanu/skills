...
- 14:30–16:45 ICT (2.25h) — Sounds Abroad | Phase 3 #12
...
```
- 09:00–12:30 ICT (3.50h) — Sounds Abroad | Phase 2 #4 Blob bootstrap
  - tags: tool:claude-code, location:bangkok, billable:none
...
```
- 10:00–14:30 ICT (4.50h) — Acme Corp | landing page redesign
  - tags: tool:cursor, location:bangkok, billable:acme-corp
...
```
- 10:00–14:30 ICT (4.50h) — Acme Corp | landing page redesign
  - tags: tool:cursor, location:bangkok, billable:acme-corp, invoiced:2026-05-31-1
  - cat: implementation 60, design 25, decisions 15
  - shipped: hero section + nav implemented; pushed to staging
```
...
- 22:00–24:00 ICT (2.00h) — Sounds Abroad | Phase 3 #15 [date split: part 1/2]
  - tags: tool:claude-code, location:bangkok, billable:none
  - cat: implementation 100
  - shipped: globe rotation tween logic

### 2026-05-20 (Wed)

- 00:00–02:00 ICT (2.00h) — Sounds Abroad | Phase 3 #15 [date split: part 2/2]
  - tags: tool:claude-code, location:bangkok, billable:none
  - cat: implementation 100
  - shipped: (continued from prev) globe rotation tween logic, PR #16 opened
```
